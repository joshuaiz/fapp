...
function hs_setup() {
	...
	if ( function_exists( 'add_image_size' ) ) {
		...
		add_image_size( 'standard', 700, 525, array( 'left', 'top' ) );			// Standard Blog Image
		add_image_size( 'medium-thumb', 300, 220, array( 'left', 'top' ) );			// medium-thumb Image
		add_image_size( 'gallery-thumb', 573, 430 );			// gallery-thumb Image
		add_image_size( 'slideshow', 1170, 427, array( 'left', 'top' ) );			// Slideshow Image
		add_image_size( 'small', 194, 150, array( 'left', 'top' ) ); 				// Related posts image
		add_image_size( 'mini', 80, 80, array( 'left', 'top' ) ); 				// sidebar widget image
		set_post_thumbnail_size( 300, 200, array( 'left', 'top' ) ); // Normal post thumbnails
	}
