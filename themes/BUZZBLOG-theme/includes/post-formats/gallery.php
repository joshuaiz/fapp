...
jQuery("#owl-demo_<?php echo $hercules_random ?>").owlCarousel({
	...
	afterInit: function(){
		...
		<!-- Slider -->
			<div id="owl-demo_<?php echo $hercules_random ?>" class="owl-carousel">
					...
					?>
					<div class="featured-thumbnail thumbnail large"><?php echo wp_get_attachment_image($attachment->ID, 'full'); ?></div>
	...
	jQuery(document).ready(function () {
			jQuery(".justifiedgall_<?php echo $hercules_random ?>").justifiedGallery({
				...
				fixedHeight: false,
				lastRow: 'justify',
				margins: <?php echo $hercules_gallery_margins; ?>,
				randomize: <?php echo $hercules_gallery_randomize; ?> 
			}); });
